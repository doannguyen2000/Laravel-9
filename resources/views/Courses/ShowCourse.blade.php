                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form id="formAccountSettings" action="{{ route('admin.managementCourse.updateCourse') }}"
                            ...
                            @endphp" hidden>
                                    <div class="row">
                                        ...
                                        @endphp"
                                                class="form-control" type="text" name="course_name" id="lastName"
                                                placeholder="Doe" />
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea id="basic-default-message" name="course_description" class="form-control"
                                                placeholder="Hi, Do you have a moment to talk Joe?">@php echo $course->course_description; @endphp</textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="organization" class="form-label">Course's content</label>
                                            <textarea
                                                name="course_content" id="content3" rows="10" cols="80">
                                                @php
                                                echo $course->course_content;
                                            @endphp
                                        </textarea>
                                        </div>
