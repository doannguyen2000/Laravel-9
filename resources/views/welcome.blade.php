                ...
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center">
                        <a href="http://127.0.0.1:8000" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-body fw-bolder">Laravel 9.x</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    <h4 class="mb-2">Welcome to Laravel 9.x! 👋</h4>
                    <p class="mb-4">Please sign-in to your account and start the adventure</p>

                    <form id="formAuthentication" class="mb-3" action="http://127.0.0.1:8000/" method="post">
                        @csrf
                        <div class="mb-3">
